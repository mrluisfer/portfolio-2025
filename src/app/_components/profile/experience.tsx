  ...
  return (
    <div className="pt-10 pb-5">
      ...
      <p className={`${CONTENT_TEXT_COLOR}`}>
        ...
        practices. I contributed to integrating tools like Sentry for API monitoring and
        ...
        products, following best practices and collaborating closely with the team to ensure timely
